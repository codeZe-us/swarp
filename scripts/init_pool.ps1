$env:POOL_CONTRACT_ID = "CCPAUFGNCXXXJZJH6WGS2UGBMDSCVASWHZH5UMXONRKR7KNFNZE3UR27"
$env:VERIFIER_CONTRACT_ID = "CC6EIDRNEJGIT2E6HN5SYLGNYLOU7YZMST37NY7T562I5AK4PIW735PI"
