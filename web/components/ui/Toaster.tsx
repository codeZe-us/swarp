...
function ToastItem({ toast }: { toast: ToastType }) {
  ...
  return (
    <div className={`pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 border ${bgColor}`}>
      <div className="p-4">
        <div className="flex items-start">
          ...
          <div className="ml-4 flex flex-shrink-0">
            <button
              type="button"
              className="inline-flex rounded-md bg-transparent text-mutedText hover:text-white"
