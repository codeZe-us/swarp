...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (!isConfigLoaded) {
    return (
      <div className="min-h-screen bg-appBackground text-primaryText flex flex-col items-center justify-center">
        {configError ? (
          <div className="text-red-500">Failed to load configuration: {configError}</div>
        ) : (
          <div className="text-mutedText flex items-center gap-3">
            <svg className="animate-spin h-5 w-5 text-primaryAccent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
