...
fn test_poseidon_parity() {
    ...
    let secret = u256_from_bytes(&env, [
    ...
    let expected_mgusd = u256_from_bytes(&env, [
        0x29, 0x79, 0x0b, 0x48, 0x18, 0x54, 0x94, 0xa7,
        0xaa, 0x4f, 0x14, 0xcf, 0xf9, 0x06, 0x4c, 0x88,
        0x39, 0x39, 0xb7, 0x01, 0xb0, 0x44, 0xd5, 0x97,
        0x7b, 0x3e, 0xd1, 0x26, 0x71, 0x24, 0x47, 0x8e
    ]);
    ...
    let expected_ylds = u256_from_bytes(&env, [
        0x12, 0x10, 0xd8, 0x3a, 0x15, 0x0a, 0xc8, 0x51,
        0x28, 0x52, 0x77, 0x45, 0xad, 0xf8, 0x07, 0x98,
        0xe5, 0x4e, 0x44, 0xed, 0xa1, 0x0c, 0xdb, 0xee,
        0xc3, 0x1f, 0xa7, 0x8f, 0x46, 0x94, 0x58, 0x28
    ]);
    ...
    let expected_xlm = u256_from_bytes(&env, [
        0x12, 0x5d, 0x86, 0x5f, 0x76, 0xd4, 0xae, 0x0e,
        0xa2, 0xa5, 0xa9, 0x02, 0xaf, 0xab, 0x83, 0xb8,
        0xef, 0x40, 0xc3, 0x2d, 0xec, 0x20, 0xff, 0xe4,
        0x7e, 0x4f, 0x7d, 0x22, 0x69, 0x8b, 0xbe, 0x4a
    ]);
    ...
    let expected_n2 = u256_from_bytes(&env, [
        0x16, 0x55, 0x6a, 0x63, 0x4d, 0x1a, 0xa9, 0xf7,
        0x23, 0x7c, 0x14, 0xa9, 0xcb, 0xbb, 0x62, 0x48,
        0x55, 0x40, 0x53, 0x3d, 0xe5, 0x75, 0x88, 0xe3,
        0x9d, 0x09, 0x30, 0xd7, 0xb5, 0x70, 0xa1, 0xb5
    ]);
    ...
    let expected_n4 = u256_from_bytes(&env, [
        0x09, 0x49, 0xa7, 0x9b, 0x29, 0x0e, 0x13, 0xdb,
        0xa7, 0xe4, 0x47, 0xb1, 0x64, 0x8f, 0xbf, 0xf0,
        0xb9, 0xa5, 0xd0, 0x49, 0x9a, 0x56, 0xd8, 0xf8,
        0x99, 0x3b, 0x7a, 0x61, 0x83, 0x35, 0xcf, 0x05 // wait, n4 ends in cf5, which is c, f, 05 ? No: 35, cf, 05? 
