...
fn test_poseidon_parity() {
    ...
    let expected_n4 = u256_from_bytes(
        &env,
        [
            0x09, 0x49, 0xa7, 0x9b, 0x29, 0x0e, 0x13, 0xdb, 0xa7, 0xe4, 0x47, 0xb1, 0x64, 0x8f,
            0xbf, 0xf0, 0xb9, 0xa5, 0xd0, 0x49, 0x9a, 0x56, 0xd8, 0xf8, 0x99, 0x3b, 0x7a, 0x61,
            0x83, 0x35, 0xcf,
            0x05, // wait, n4 ends in cf5, which is c, f, 05 ? No: 35, cf, 05?
        ],
    ); // 0x0949a79b290e13dba7e447b1648fbff0b9a5d0499a56d8f8993b7a618335cf5 -> 05?
